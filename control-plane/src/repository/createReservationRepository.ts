import type { ApiKeyRepository, CapacityProviderRepository, CapacityTargetRepository, ReservationRepository, TargetModelDiscoveryRepository, TargetProvisioningJobRepository } from "../domain/interfaces.js";
...
export async function createReservationRepository(config: StorageConfig): Promise<ReservationRepositoryHandle> {
  ...
  return { repository, apiKeys, capacityProviders, capacityTargets, targetProvisioningJobs, targetModelDiscoveries, close: async () => undefined };
}
